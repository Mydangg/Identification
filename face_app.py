...
for i in range(3):
    ...
    if cap.isOpened():
        print(f"Camera index {i} mở được!")
    else:
        print(f"Camera index {i} không mở được.")
    cap.release()
...
icon = PhotoImage(file='../Project - Copy/img/VKU.png')
...
label_title2 = tk.Label(main_frame, text='Artificial Intelligent in Business', 
                        ...
                        bg='#faf79b')
# Title 3
label_title3 = tk.Label(main_frame, text='My, Khuyen', 
                        font=("Arial", 15), 
                        fg="blue",
                        bg='#faf79b')
...
#save model
face_app.py.save("nhandienkhuonmat.h5")
print("Finish model!")